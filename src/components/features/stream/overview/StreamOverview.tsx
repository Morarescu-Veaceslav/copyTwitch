...
export function StreamOverview({ channel }: StreamOverviewProps) {
    ...
    return <LiveKitRoom
        ...
        className='mx-auto grid max-w-screen-xl grid-cols-1 gap-6 lg:grid-cols-7 w-full'>
        ...
        <div className='order-2 col-span-1 flex h-80 flex-col space-y-6 lg:col-span-2'>
            <LiveChat channel={channel} isChatEnabled={channel.stream.isChatEnabled}
                isChatFollowersOnly={channel.stream.isChatFollowersOnly} isChatPremiumFollowersOnly={channel.stream.isChatPremiumFollowersOnly} />
        </div>
    </LiveKitRoom>
}
...
export function StreamOverviewSkeleton() {
    return (
        <div className='mx-auto grid max-w-screen-xl grid-cols-1 gap-6 lg:grid-cols-7 w-full'>
            <div className='order-1 col-span-1 flex flex-col lg:col-span-5'>
                <StreamVideoSkeleton />
                <StreamInfoSkeleton />
