...
import { GraphQLUpload, FileUpload, graphqlUploadExpress } from 'graphql-upload';
...
export class StreamResolver {
  ...
  public async changeThumbnail(
    @Authorized() user: User,
    @Args('thumbnail', { type: () => GraphQLUpload }, FileValidationPipe) thumbnail: Promise<FileUpload>
  ) {
