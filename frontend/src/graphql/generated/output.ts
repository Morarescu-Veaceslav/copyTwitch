...
export type UserModel = {
  ...
  avatarMimeType?: Maybe<Scalars['String']['output']>;
  ...
  sponsorshipSubscription: Array<SubscriptionModel>;
  stream: StreamModel;
...
export type VerifyAccountMutation = { __typename?: 'Mutation', verifyAccount: { __typename?: 'UserModel', id: string, email: string, isEmailVerified: boolean } };
...
export type UnfollowChanelMutationVariables = Exact<{
  chanelId: Scalars['String']['input'];
}>;


export type UnfollowChanelMutation = { __typename?: 'Mutation', unfollowChannel: boolean };
...
export type FindAllCategoriesQuery = { __typename?: 'Query', findAllCategories: Array<{ __typename?: 'CategoryModel', id: string, updatedAt: any, title: string, slug: string, thumbnailUrl?: string | null }> };
...
export type FindCategoryBySlugQuery = { __typename?: 'Query', findCategoryBySlug: { __typename?: 'CategoryModel', title: string, description?: string | null, thumbnailUrl?: string | null, streams: Array<{ __typename?: 'StreamModel', title: string, isLive: boolean, thumbnailUrl?: string | null, user: { __typename?: 'UserModel', username: string, isVerified: boolean }, category: { __typename?: 'CategoryModel', title: string, slug: string } }> } };
...
export type FindChannelByUsernameQuery = { __typename?: 'Query', findChannelByUsername: { __typename?: 'UserModel', id: string, username: string, displayName: string, isVerified: boolean, avatar?: string | null, bio?: string | null, socialLinks: Array<{ __typename?: 'SocialLinkModel', title: string, url: string }>, stream: { __typename?: 'StreamModel', id: string, title: string, thumbnailUrl?: string | null, isLive: boolean, isChatEnabled: boolean, isChatFollowersOnly: boolean, isChatPremiumFollowersOnly: boolean, category: { __typename?: 'CategoryModel', id: string, title: string } }, sponsorshipPlans: Array<{ __typename?: 'PlanModel', id: string, title: string, description?: string | null, price: number }>, followings: Array<{ __typename?: 'FollowModel', id: string }> } };

export type FindRecommendedChannelsQueryVariables = Exact<{ [key: string]: never; }>;


export type FindRecommendedChannelsQuery = { __typename?: 'Query', findRecommendedChannels: Array<{ __typename?: 'UserModel', username: string, displayName: string, avatar?: string | null, isVerified: boolean, stream: { __typename?: 'StreamModel', isLive: boolean } }> };
...
export type FindSponsorsByChannelQuery = { __typename?: 'Query', findSponsorsByChannel: Array<{ __typename?: 'SubscriptionModel', user: { __typename?: 'UserModel', id: string, username: string } }> };
...
export type FindMyFollowersQuery = { __typename?: 'Query', findMyFollowers: Array<{ __typename?: 'FollowModel', createdAt: any, follower: { __typename?: 'UserModel', username: string, isVerified: boolean } }> };
...
export type FindMySponsorsQuery = { __typename?: 'Query', findMySponsors: Array<{ __typename?: 'SubscriptionModel', expiresAt: any, user: { __typename?: 'UserModel', username: string, isVerified: boolean }, plan: { __typename?: 'PlanModel', title: string } }> };
...
export type FindAllStreamsQuery = { __typename?: 'Query', findAllStreams: Array<{ __typename?: 'StreamModel', title: string, isLive: boolean, thumbnailUrl?: string | null, user: { __typename?: 'UserModel', username: string, isVerified: boolean }, category: { __typename?: 'CategoryModel', title: string, slug: string } }> };

export type FindRandomStreamsQueryVariables = Exact<{ [key: string]: never; }>;


export type FindRandomStreamsQuery = { __typename?: 'Query', findRandomStreams: Array<{ __typename?: 'StreamModel', title: string, isLive: boolean, thumbnailUrl?: string | null, user: { __typename?: 'UserModel', username: string, isVerified: boolean }, category: { __typename?: 'CategoryModel', title: string, slug: string } }> };
...
export type FindNotificationsByUserQuery = { __typename?: 'Query', findNotificationsByUser: Array<{ __typename?: 'NotificationModel', id: string, message: string, isRead: boolean, type: NotificationType }> };
...
export const UnfollowChanelDocument = gql`
    mutation UnfollowChanel($chanelId: String!) {
  unfollowChannel(channelId: $chanelId)
}
    `;
export type UnfollowChanelMutationFn = Apollo.MutationFunction<UnfollowChanelMutation, UnfollowChanelMutationVariables>;

/**
 * __useUnfollowChanelMutation__
 *
 * To run a mutation, you first call `useUnfollowChanelMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUnfollowChanelMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [unfollowChanelMutation, { data, loading, error }] = useUnfollowChanelMutation({
 *   variables: {
 *      chanelId: // value for 'chanelId'
 *   },
 * });
 */
export function useUnfollowChanelMutation(baseOptions?: Apollo.MutationHookOptions<UnfollowChanelMutation, UnfollowChanelMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UnfollowChanelMutation, UnfollowChanelMutationVariables>(UnfollowChanelDocument, options);
      }
export type UnfollowChanelMutationHookResult = ReturnType<typeof useUnfollowChanelMutation>;
export type UnfollowChanelMutationResult = Apollo.MutationResult<UnfollowChanelMutation>;
export type UnfollowChanelMutationOptions = Apollo.BaseMutationOptions<UnfollowChanelMutation, UnfollowChanelMutationVariables>;
...
export const RemoveSponsorshipPlanDocument = gql`
    mutation RemoveSponsorshipPlan($data: String!) {
  removeSponsorshipPlan(data: $data)
}
    `;
