...
export function Search() {
    const translation = useTranslations('layout.header.search')
    ...
    return <div className='ml-auto hidden lg:block'>
        <form className='relative flex items-center' onSubmit={onSubmit}>
            ...
            <Button className='absolute right-0.5 h-9' type="submit"><SearchIcon className='absolute size-[18px]' /></Button>
        </form>
    </div>
}