...
export function StreamInfo({ channel }: StreamInfoProps) {
    ...
    const translation = useTranslations('stream.info')
                    ...
                    <div className='space-y-1'>
                        ...
                        {channel.stream.isLive ? (
                            ...
                            font-semibold text-rose-500'>
                                ...
                                {participantCount} {translation('viewers')}
                            </div>
                        ) : (
                            <p className='text-xs font-semibold text-muted-foreground'>{translation('offline')}</p>
                        )}
                    </div>
                </div>
